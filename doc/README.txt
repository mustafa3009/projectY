...
e.g.	code/ec2/run.sh voting-app conf/conf/ec2/cf-voting-app-ec2.template candidate1
...
conf - Stores the configuration files like cloudformation templates. These templates can be imported into a 
		cloudformation designer to visualize it as a schematic.
